...
test('industry company library uses the Figma-style light blue surface and compact table treatment', () => {
  assert.match(styleBlock('.industry-company-board'), /background:\s*#dbeafe/)
  ...
  assert.match(styleBlock('.industry-company-chain-row'), /width:\s*min\(690px, 100%\)/)
  ...
  assert.match(styleBlock('.industry-company-chain-row'), /background:\s*rgba\(255, 255, 255, 0\.3\)/)
  ...
  assert.match(styleBlock('.industry-company-segments'), /grid-template-columns:\s*repeat\(4, minmax\(0, 1fr\)\)/)
  assert.match(styleBlock('.industry-company-segments button'), /min-height:\s*36px/)
  assert.match(styleBlock('.industry-company-segments button'), /font-size:\s*13px/)
  assert.match(styleBlock('.industry-company-segments button'), /font-weight:\s*800/)
  assert.match(styleBlock('.industry-company-segments button.active'), /border-color:\s*transparent/)
  assert.match(styleBlock('.industry-company-segments button.active'), /background:\s*rgba\(255, 255, 255, 0\.86\)/)
  assert.match(styleBlock('.industry-company-ai-card'), /height:\s*108px/)
  assert.match(styleBlock('.industry-company-ai-card'), /grid-template-columns:\s*118px minmax\(0, 1fr\)/)
  assert.match(styleBlock('.industry-company-ai-card'), /gap:\s*32px/)
  assert.match(styleBlock('.industry-company-ai-card'), /padding:\s*12px 24px 16px/)
  assert.match(styleBlock('.industry-company-ai-card'), /border:\s*1px solid #ffffff/)
  assert.match(styleBlock('.industry-company-ai-card'), /background:\s*rgba\(255, 255, 255, 0\.6\)/)
  ...
  assert.match(styleBlock('.industry-company-ai-card strong'), /font-size:\s*13px/)
  assert.match(styleBlock('.industry-company-ai-bullets'), /gap:\s*7px/)
  assert.match(styleBlock('.industry-company-ai-bullets li'), /font-size:\s*13px/)
  assert.match(styleBlock('.industry-company-list-card'), /border:\s*1px solid #d6e3fb/)
  assert.match(styleBlock('.industry-company-list-card'), /background:\s*rgba\(255, 255, 255, 0\.62\)/)
