...
const fieldSheets = {
  ...
  "04A_产业环节关系库": [
    field("relation_id", "产业环节关系ID", "string", "是", "PK", "产业环节之间连线或桑基图边的唯一标识。", "rel_software_smart_site", "系统生成/产业库导入", "创建时", ""),
    field("chain_id", "所属产业链ID", "string", "是", "FK", "关系所属产业链，用于按链条过滤边。", "chain_smart_construction", "产业链库", "创建时", "关联03_产业链库"),
    field("source_node_id", "来源产业环节ID", "string", "是", "FK", "产业关系或桑基图连线起点。", "node_engineering_software", "产业环节库", "按项目维护", "关联04_产业环节库.industry_node_id"),
    field("target_node_id", "目标产业环节ID", "string", "是", "FK", "产业关系或桑基图连线终点。", "node_smart_site", "产业环节库", "按项目维护", "关联04_产业环节库.industry_node_id"),
    field("relation_type", "关系类型", "enum", "是", "IDX", "上下游供给、平台支撑、数据协同、工程实施、监管反馈等。", "平台支撑", "产业研究/人工维护", "按版本", ""),
    field("relation_value", "关系强度", "number", "否", "IDX", "桑基图或关系图连线权重，可来自企业数、需求量或专家校准指数。", "19", "产业统计/人工校准", "按版本", "用于桑基图宽度"),
    field("relation_desc", "关系说明", "text", "否", "", "说明来源环节如何支撑、供给、转化或联动目标环节。", "工程软件与数据服务支撑智慧工地平台实施。", "产业研究/AI生成后审核", "按版本", ""),
    field("evidence_tags", "证据标签", "text", "否", "", "支撑该关系的技术、场景、企业或岗位关键词。", "工程数据标准、IoT接入、平台实施", "产业资料/招聘归并/人工复核", "按版本", ""),
    field("source_url", "来源链接", "url", "否", "", "支撑该关系判断的政策、产业研究、图谱或人工维护记录。", "https://www.miit.gov.cn/zwgk/zcwj/", "数据来源库", "随采集", ""),
    field("updated_at", "更新时间", "datetime", "否", "", "关系最近更新或复核时间。", "2026-06-23 10:00", "系统生成", "每次维护", ""),
  ],
  "05_职业库": [
  ...
  "06_岗位库": [
    ...
    field("related_major_codes", "关联专业", "text", "否", "", "岗位可对接或支撑的专业代码列表，用于从岗位画像直接回连专业库。", "440301,440304", "专业库/岗位画像/规则匹配", "按版本", "关联01_专业库.major_code"),
    ...
    field("industry_code", "所属行业代码", "string", "是", "FK", "岗位所属行业代码，按岗位归属行业映射到国民经济行业分类。", "I65", "行业库/招聘归并/人工维护", "按批次", "关联02_行业库"),
    field("industry_name", "所属行业名称", "string", "否", "IDX", "岗位所属行业展示名称，冗余自行业库用于页面展示和筛选。", "软件和信息技术服务业", "行业库/规则映射", "按批次", "冗余展示字段"),
...
const sources = [
  ...
  ["产业环节关系库", "产业链图谱/桑基图人工复核记录", "", "产业环节之间的上下游、支撑、协同关系和连线权重", "运营维护记录", "按版本"],
...
const relations = [
  ...
  ["rel_chain_node_relation", "产业链", "产业环节关系", "1:N", "chain_id -> chain_id", "产业环节关系归属具体产业链，避免跨链条边关系混用。"],
  ["rel_node_relation_source", "产业环节", "产业环节关系", "1:N", "industry_node_id -> source_node_id", "产业环节作为关系起点，表达向下游或协同环节的供给、支撑、转化关系。"],
  ["rel_node_relation_target", "产业环节关系", "产业环节", "N:1", "target_node_id -> industry_node_id", "产业环节关系指向目标环节，用于桑基图和产业关系图连线。"],
  ["rel_node_job", "产业环节", "岗位", "1:N", "industry_node_id -> job_id", "岗位承接具体产业环节，用于图谱和岗位画像。"],
  ["rel_job_industry", "岗位", "行业", "N:1", "industry_code", "岗位按国民经济行业分类归属行业，用于行业维度筛选、统计和趋势分析。"],
  ["rel_job_occupation", "岗位", "职业", "N:1", "occupation_code", "平台岗位归一到国家职业分类。"],
  ["rel_job_major", "岗位", "专业", "N:M", "related_major_codes -> major_code", "岗位画像可直接关联多个专业，用于从岗位侧回溯专业建设对象。"],
